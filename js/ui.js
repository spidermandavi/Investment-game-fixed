...
function showPodium(scores){
  ...
  if(document.getElementById("firstPlace")) document.getElementById("firstPlace").innerText = scores[0].name;
  if(document.getElementById("secondPlace")) document.getElementById("secondPlace").innerText = scores[1]?.name || "";
  if(document.getElementById("thirdPlace")) document.getElementById("thirdPlace").innerText = scores[2]?.name || "";
